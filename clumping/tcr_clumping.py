...
from .preprocess import tcrs_from_dataframe_helper
...
def estimate_background_tcrdist_distributions(
    ...
    if not util.tcrdist_cpp_available():
        print('clumping.tcr_clumping.estimate_background_tcrdist_distributions:: need to compile the C++ tcrdist executables')
        exit(1)
